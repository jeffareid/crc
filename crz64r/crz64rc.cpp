...
extern "C" uint64_t crz64ra(uint64_t, uint8_t *, size_t);
...
uint64_t crz64rc(uint64_t crc64, uint8_t * bfr, size_t size)
{
uint64_t crc = crc64;
    while(size--)
...
int main(int argc, char**argv)
{
    ...
    for (size_t i = 0; i < SIZE; i += 8){
        bfr[i+0x00] = (uint8_t)0x80;
        bfr[i+0x01] = (uint8_t)0x40;
        bfr[i+0x02] = (uint8_t)0x20;
        bfr[i+0x03] = (uint8_t)0x10;
        bfr[i+0x04] = (uint8_t)0x08;
        bfr[i+0x05] = (uint8_t)0x04;
        bfr[i+0x06] = (uint8_t)0x02;
        bfr[i+0x07] = (uint8_t)0x01;
    }
    {
        size_t i;
        for (i = 1; i < 4095; i++) {
            crcc = crz64rc(0x0ull, bfr, i);
            crcf = crz64ra(0x0ull, bfr, i);
